...
-- select 칼럼명 from 테이블 이름 where 조건(true/false)

-- 전체 사원중의 월 급여가 3000 이상인 사원의 리스트
select ename, sal
from emp
where sal >= 3000
;
...
select *
from emp
--where hiredate>'1986-01-01' -- 1987년 이후
--where hiredate >= '1981-01-01 and hiredate <= '1981-12-31'
where hiredate between '1981-01-01' and '1981-12-31'
;

-- or 연산을 간소화 시키는 IN 연산자
-- 칼럼이름 IN(데이터1, 데이터2, 데이터3, ...)
-- 칼럼=데이터1 or 칼럼=데이터2 or 칼럼=데이터3 or ...

-- 커미션이 300 이거나 500 이거나 1400인 사원을
...
-- 칼럼명 is null : 해당 칼럼의 값이 null인 경우 true
-- 칼럼명 is not null : 해당 칼럼의 값이 null이 아닌 경우 true
select ename, comm
from emp
--where comm is null
