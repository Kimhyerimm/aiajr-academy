...
select *from emp01
--where hiredate between *1986/01/01' and '1987/12/31'
...
--1. 20번 부서의 지역명을 
--40번 부서의 지역명으로 변경하기 위해서 서브쿼리문을 사용해 봅시다. 
update dept01
set loc=(
...
loc=(select loc fom dept01 where deptno=40)
where deptno=20
;
...
--사원 테이블에서 
--부서명이 SALES인 사원을 모두 삭제해보도록 하겠습니다. 
