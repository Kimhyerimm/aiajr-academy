...
from emp e, emp m
where e.mgr = m.empno(+) --KING의 null 출력된다.
order by e.empno --사원번호 빠른순서(오름차순)
;
...
-- 사원의 이름, 부서번호, 지정한 사원과 동일한 부서에서 근무하는 사원을 출력하시오. ( SCOTT )
select ename from emp where deptno=20; --검증해보기
...
--41. SELF JOIN을 사용하여 WARD 사원보다 늦게 입사한 
--사원의 이름과 입사일을 출력하시오.
